...
#if EFM8BB1_SUPPORT_AC11401B_PROTOCOL == 1
#define AC11401B
SI_SEGMENT_VARIABLE(PROTOCOL_BUCKETS(AC11401B)[], static uint16_t, SI_SEG_CODE) = { 5280, 610, 290, 5290 };
SI_SEGMENT_VARIABLE(PROTOCOL_START(AC11401B)[], static uint8_t, SI_SEG_CODE) = { HIGH(0), LOW(1) };
SI_SEGMENT_VARIABLE(PROTOCOL_BIT0(AC11401B)[], static uint8_t, SI_SEG_CODE) = { HIGH(2), LOW(1) };
SI_SEGMENT_VARIABLE(PROTOCOL_BIT1(AC11401B)[], static uint8_t, SI_SEG_CODE) = { HIGH(1), LOW(2) };
SI_SEGMENT_VARIABLE(PROTOCOL_END(AC11401B)[], static uint8_t, SI_SEG_CODE) = { HIGH(1), LOW(3) };
#endif

#if EFM8BB1_SUPPORT_DOOYACURT_PROTOCOL == 1
#define DOOYA
SI_SEGMENT_VARIABLE(PROTOCOL_BUCKETS(DOOYA)[], static uint16_t, SI_SEG_CODE) = { 4800, 1500, 360, 730, 8860 };
SI_SEGMENT_VARIABLE(PROTOCOL_START(DOOYA)[], static uint8_t, SI_SEG_CODE) = { HIGH(0), LOW(1) };
SI_SEGMENT_VARIABLE(PROTOCOL_BIT0(DOOYA)[], static uint8_t, SI_SEG_CODE) = { HIGH(2), LOW(3) };
SI_SEGMENT_VARIABLE(PROTOCOL_BIT1(DOOYA)[], static uint8_t, SI_SEG_CODE) = { HIGH(3), LOW(2) };
SI_SEGMENT_VARIABLE(PROTOCOL_END(DOOYA)[], static uint8_t, SI_SEG_CODE) = { HIGH(3), LOW(4) };
#endif
...
#if EFM8BB1_SUPPORT_AC11401B_PROTOCOL == 1
		/*
		 * RF Transmitter model AC114-01B
		 */
		{
			{ &PROTOCOL_BUCKETS(AC11401B), ARRAY_LENGTH(PROTOCOL_BUCKETS(AC11401B)) },
			{ &PROTOCOL_START(AC11401B), ARRAY_LENGTH(PROTOCOL_START(AC11401B)) },
			{ &PROTOCOL_BIT0(AC11401B), ARRAY_LENGTH(PROTOCOL_BIT0(AC11401B)) },
			{ &PROTOCOL_BIT1(AC11401B), ARRAY_LENGTH(PROTOCOL_BIT1(AC11401B)) },
			{ &PROTOCOL_END(AC11401B), ARRAY_LENGTH(PROTOCOL_END(AC11401B)) },
			64
		},
#endif
#if EFM8BB1_SUPPORT_DOOYACURT_PROTOCOL == 1
		/*
		 * RF Transmitter model DOOYA CURTAINS
		 */
		{
			{ &PROTOCOL_BUCKETS(DOOYA), ARRAY_LENGTH(PROTOCOL_BUCKETS(DOOYA)) },
			{ &PROTOCOL_START(DOOYA), ARRAY_LENGTH(PROTOCOL_START(DOOYA)) },
			{ &PROTOCOL_BIT0(DOOYA), ARRAY_LENGTH(PROTOCOL_BIT0(DOOYA)) },
			{ &PROTOCOL_BIT1(DOOYA), ARRAY_LENGTH(PROTOCOL_BIT1(DOOYA)) },
			{ &PROTOCOL_END(DOOYA), ARRAY_LENGTH(PROTOCOL_END(DOOYA)) },
			39
		}
#endif
};
